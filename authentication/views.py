...
from myloginsystem import settings
from django.core.mail import send_mail
from django.contrib.sites.shortcuts import get_current_site
from django.template.loader import render_to_string
from django.utils.encoding import force_bytes,force_str
from myloginsystem.info import EMAIL_HOST_USER
...
def signup(request):
    if request.method == "POST":
        ...
        messages.success(request, "Your Account has been cretaed Successfully.We have sent you a confirmation email,Please confirm your email to activate your account.")


        #Welcome email

        subject = "Welcome to Srikant Tech Solutions!!"
        message = "Hello" + myuser.first_name + "!! \n" + "Welcome to STS login!! \n Thank you for visiting our website \n  We have also sent you a confirmation email,please confirm your email address in order to activate your account. |n |n Thanking you\n Srikant Jena"
        ...
        email_subject = "Confirm your email STS login system!!"
